...
class ModelLocalisationCountry extends Model {
	public function addCountry($data) {
		...
		$this->db->query("UPDATE " . DB_PREFIX . "country SET tel_pref = '" . $this->db->escape($data['tel_pref']) . "', trans_name = '" . $this->db->escape($data['trans_name']) . "' WHERE country_id = '" . (int)$country_id . "'");
