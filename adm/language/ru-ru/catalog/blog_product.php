...
$_['column_category']         = 'Блог-Категория';
...
// Entry
$_['entry_main_category']       = 'Главная блог-категория:';
...
$_['entry_image']          		= 'Изображение для статьи:';
...
$_['entry_category']          	= 'Показывать в блог-категориях:';
$_['entry_filter']          	= 'Фильтры:';
$_['entry_download']          	= 'Загрузки:';
$_['entry_related']          	= 'Сопутствующие статьи:';
...
$_['help_upc']          		= 'Универсальный код статьи';
$_['help_ean']          		= 'Европейский номер статьи (штрихкод EAN-13)';
...
$_['help_minimum']          	= 'Минимальное количество для заказа этогй статьи';
...
$_['error_name']          		= 'Наименование статьи должно быть от 3 до 255 символов!';
$_['error_meta_title']          = 'Мета-тег Title должен быть от 3 до 255 символов!';
$_['error_model']          		= 'Модель статьи должна быть от 3 до 64 символов!';
