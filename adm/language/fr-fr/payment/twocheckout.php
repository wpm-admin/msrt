...
// Entry
$_['entry_account']			= 'N&deg; de compte 2Checkout :';
$_['entry_secret']			= 'Mot secret :';
$_['entry_display']			= 'Commande r&eacute;&eacute;lle';
...
// Help
$_['help_secret']			= 'Le mot secret pour confirmer les transactions doit &ecirc;tre le m&ecirc;me que celui d&eacute;fini sur la page de configuration du compte.';
$_['help_total']			= 'Montant total que la commande doit atteindre avant que ce mode de paiement ne devienne actif.';

// Error
$_['error_permission']		= 'Attention, vous n&#8217;avez pas la permission de modifier le paiement <b>2Checkout</b> !';
$_['error_account']			= 'Attention, le N&deg; de compte 2Checkout  est requis !';
