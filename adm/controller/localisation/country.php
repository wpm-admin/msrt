...
class ControllerLocalisationCountry extends Controller {
	...
	protected function getList() {
		...
		foreach ($results as $result) {
			$data['countries'][] = array(
				...
				'tel_pref' => $result['tel_pref'],
				'trans_name' => $result['trans_name'],
		...
		$data['sort_tel_pref'] = $this->url->link('localisation/country', 'user_token=' . $this->session->data['user_token'] . '&sort=tel_pref' . $url, true);
		$data['sort_trans_name'] = $this->url->link('localisation/country', 'user_token=' . $this->session->data['user_token'] . '&sort=trans_name' . $url, true);
	...
	protected function getForm() {
		...
		if (isset($this->request->post['tel_pref'])) {
			$data['tel_pref'] = $this->request->post['tel_pref'];
		} elseif (!empty($country_info)) {
			$data['tel_pref'] = $country_info['tel_pref'];
		} else {
			$data['tel_pref'] = '';
		}

		if (isset($this->request->post['trans_name'])) {
			$data['trans_name'] = $this->request->post['trans_name'];
		} elseif (!empty($country_info)) {
			$data['trans_name'] = $country_info['trans_name'];
		} else {
			$data['trans_name'] = '';
		}
	...
	public function country() {
		...
		if ($country_info) {
			...
			$json = array(
				...
				'tel_pref'              => $country_info['tel_pref'],
				'trans_name'              => $country_info['trans_name'],
