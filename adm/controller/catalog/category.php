...
class ControllerCatalogCategory extends Controller {
	...
	protected function getForm() {
		...
		if (isset($this->request->post['is_diagram'])) {
			$data['is_diagram'] = (int)$this->request->post['is_diagram'];
		} elseif (!empty($category_info)) {
			$data['is_diagram'] = (int)$category_info['is_diagram'];
		} else {
			$data['is_diagram'] = 1;
		}
	...
	protected function validateForm() {
		...
		if (false and $this->request->post['category_seo_url']) {
