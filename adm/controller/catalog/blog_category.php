...
class ControllerCatalogBlogCategory extends Controller {
	...
	public function delete() {
		...
		if (isset($this->request->post['selected']) && $this->validateDelete()) {
			foreach ($this->request->post['selected'] as $blog_category_id) {
				$this->model_catalog_blog_category->deleteCategory($blog_category_id);
			}
	...
	protected function getList() {
		...
		$data['repair'] = $this->url->link('catalog/blog_category/repair', 'user_token=' . $this->session->data['user_token'] . $url, true);
		...
		$blog_category_total = $this->model_catalog_blog_category->getTotalCategories();
		...
		foreach ($results as $result) {
			$data['categories'][] = array(
				...
				'delete'      => $this->url->link('catalog/blog_category/delete', 'user_token=' . $this->session->data['user_token'] . '&blog_category_id=' . $result['blog_category_id'] . $url, true)
			);
		}
	...
	protected function getForm() {
		...
		if (isset($this->request->get['blog_category_id']) && ($this->request->server['REQUEST_METHOD'] != 'POST')) {
			$blog_category_info = $this->model_catalog_blog_category->getCategory($this->request->get['blog_category_id']);
		}
		...
		if (isset($this->request->post['blog_category_description'])) {
			...
			$data['blog_category_description'] = $this->model_catalog_blog_category->getCategoryDescriptions($this->request->get['blog_category_id']);
		} else {
		...
		$data['blog_category_filters'] = array();
		...
		if (isset($this->request->post['blog_category_store'])) {
			...
			$data['blog_category_store'] = $this->model_catalog_blog_category->getCategoryStores($this->request->get['blog_category_id']);
		} else {
		...
		if (isset($this->request->post['top'])) {
			...
			$data['top'] = $blog_category_info['top'];
		} else {
			$data['top'] = 0;
		}
		...
		if (isset($this->request->post['column'])) {
			...
			$data['column'] = $blog_category_info['column'];
		} else {
			$data['column'] = 1;
		}
		...
		if (isset($this->request->post['blog_category_seo_url'])) {
			...
			$data['blog_category_seo_url'] = $this->model_catalog_blog_category->getCategorySeoUrls($this->request->get['blog_category_id']);
		} else {
		...
		if (isset($this->request->post['blog_category_layout'])) {
			...
			$data['blog_category_layout'] = $this->model_catalog_blog_category->getCategoryLayouts($this->request->get['blog_category_id']);
		} else {
	...
	protected function validateForm() {
		...
		if (false and $this->request->post['blog_category_seo_url']) {
