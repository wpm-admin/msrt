...
class ControllerCommonColumnLeft extends Controller {
	public function index() {
		if (isset($this->request->get['user_token']) && isset($this->session->data['user_token']) && ($this->request->get['user_token'] == $this->session->data['user_token'])) {
			...
			if ($this->user->hasPermission('access', 'catalog/mark')) {
				$catalog[] = array(
					'name'	   => 'Mark and models',
					'href'     => $this->url->link('catalog/mark', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()
				);
			}
			...
			if ($this->user->hasPermission('access', 'catalog/production')) {
				$catalog[] = array(
					'name'	   => 'Windshield-production',
					'href'     => $this->url->link('catalog/production', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()
				);
			}
			...
			if ($this->user->hasPermission('access', 'catalog/product')) {
				$catalog[] = array(
					'name'	   => $this->language->get('text_product').' - batch',
					'href'     => $this->url->link('batch_editor/index', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()
				);
			}

			if ($this->user->hasPermission('access', 'catalog/consignment')) {
				$catalog[] = array(
					'name'	   => 'Classified Ads',
					'href'     => $this->url->link('catalog/consignment', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()
				);
			}
			...
			if (false and $this->user->hasPermission('access', 'catalog/provider')) {
				$catalog[] = array(
					'name'	   => 'Vendor',
					'href'     => $this->url->link('catalog/provider', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()
				);
			}
			...
			if ($this->user->hasPermission('access', 'catalog/review')) {
			    ...
			    if ($this->user->hasPermission('access', 'catalog/blog_category')) {
					...
					$blogs[] = array(
						'name'	   => 'Blog',
						'href'     => $this->url->link('catalog/blog_product', 'user_token=' . $this->session->data['user_token'], true),
						'children' => array()		
					);
			...
			if ($this->user->hasPermission('access', 'import/import')) {
				$import[] = array(
					'name'	   => 'import API',
					'href'     => $this->url->link('import/import', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()
				);
			}
			if ($this->user->hasPermission('access', 'import/import_tools')) {
				$import[] = array(
					'name'	   => 'import Tools',
					'href'     => $this->url->link('import/import_tools', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()
				);
			}
			if ($import) {
			...
			if ($this->user->hasPermission('access', 'design/seo_url_generator')) {
				$design[] = array(
					'name'	   => 'SEO URL generator',
					'href'     => $this->url->link('design/seo_url_generator', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()
				);
			}
			...
			if ($this->user->hasPermission('access', 'vendor/vendor_group')) {
				$vendor[] = array(
					'name'	   => 'Vendor group',
					'href'     => $this->url->link('vendor/vendor_group', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()
				);
			}

			if ($this->user->hasPermission('access', 'vendor/vendor_approval')) {
				$vendor[] = array(
			...
			if ($this->user->hasPermission('access', 'vendor/vendor_field')) {
				$vendor[] = array(
					'name'	   => 'Vendor field',
					'href'     => $this->url->link('vendor/vendor_field', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()
				);
			}
			...
			if ($this->user->hasPermission('access', 'localisation/condition_status')) {
				$localisation[] = array(
					'name'	   => 'Condition product',
					'href'     => $this->url->link('localisation/condition_status', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()
				);
			}
