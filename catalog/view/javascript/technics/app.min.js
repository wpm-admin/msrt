            ...
            (e =
                window.innerWidth < 768
                    ? ($(".topbar div.ctrl").empty(),
                      ...
                      $(".slider figure.slides__item-image").attr("data-padding-mob"))
                    : ($("div.nav__mobile").siblings("div.ctrl").empty(),
                      ...
                      $(".slider figure.slides__item-image").attr("data-padding"))),
            $(".slider figure.slides__item-image[data-padding-mob]").css("padding-top", e + "%"));
}
function onresize() {
...
function search() {
    ...
    $(".js-search").on("click", ".search__send", function (e) {
        ...
        $(".js-search-input").autocomplete({
            source: function (e, t) {
                //console.log('search2');
                //console.log($('.autocomplete_href').val()+"?filter_name=" + encodeURIComponent(e));
                
                var params = '';
                if($(this).data('style') == 'product_add'){
                    params = '&product_add';
                }
                
                console.log($('.autocomplete_href').val()+"?diagram=2&filter_name=" + encodeURIComponent(e) + params);
                
                $.ajax({
                    url: $('.autocomplete_href').val()+"?diagram=2&filter_name=" + encodeURIComponent(e) + params,
                    dataType: "json",
                    success: function (e) {
                        ...
                        if(params == '&product_add'){
                            t(
                                $.map(e, function (e) {
                                    return { type: "search", label: e.name, price: e.price, model: e.model, special: e.special, image1: e.image, value: 'javascript:;', id: e.product_id, href: e.href_search, show_all: e.show_all };
                                })
                            );
                        }else{
                            t(
                                $.map(e, function (e) {
                                    return { type: "search", label: e.name, price: e.price, model: e.model, special: e.special, image1: e.image, value: e.href, id: e.product_id, href: e.href_search, show_all: e.show_all };
                                })
                            );
...
function slick(e) {
    ...
    (null != e && ".js-gallery" != e) ||
        ...
        (null != e && ".js-slick-slides" != e) ||
            ...
            $(".js-slick-slides").on("lazyLoaded", function (e, t, s) {
                s.closest("picture")
                    .find("source[data-lazy-srcset]")
                    .each(function (e, t) {
                        ($source = $(t)), $source.attr("srcset", $source.data("lazy-srcset"));
                    });
            })),
    ...
    a.fn.autocomplete = function (e) {
        return this.each(function () {
            ...
            a.extend(this, e),
                ...
                a(this).on("keydown", function (e) {
                    27 === e.keyCode ? this.hide() : this.request();
                }),
                (this.click = function (e) {
                    e.preventDefault(),
                        (t = a(e.target).closest("li").attr("data-value")) && this.items[t] && ("search" == this.items[t].type ? (window.location = this.items[t].value) : this.select(this.items[t])),
                        "button" == t && (window.location = a(e.target).attr("href"));
                }),
                (this.show = function () {
                    var e = a(this).position();
                    a(this)
                        .siblings("ul.dropdown-menu")
                        .css({ top: e.top + a(this).outerHeight(), left: e.left }),
                ...
                (this.request = function () {
                    clearTimeout(this.timer),
                        (this.timer = setTimeout(
                            function (e) {
                                e.source(a(e).val(), a.proxy(e.response, e));
                            },
                            200,
                            this
                        ));
                ...
                (this.response = function (e) {
                    if (e.length && "search" == e[0].type) {
                        if (((o = '<ul class="search__list">'), e.length)) {
                            var t = 0;
                            for (i = 0; i < e.length; i++) this.items[e[i].id] = e[i];
                            for (i = 0; i < e.length; i++)
                                e[i].category ||
                                    (e[i].image1
                                        ? ((o += '<li data-value="' + e[i].id + '"><a class="search__item" href="' + e[i].value + '">'),
                                          (o += '<figure class="search__item-image"><img src="' + e[i].image1 + '" alt=""></figure>'),
                                          (o += '<p class="search__item-title">'),
                                          e[i].model && (o += '<span class="search__item-model">' + e[i].model + "</span>"),
                                          (o += e[i].label),
                                          (o += "</p>"),
                                          e[i].special
                                              ? (o += '<p class="search__item-price"><b>' + e[i].special + "</b><u>" + e[i].price + "</u></p></a></li>")
                                              : (o += '<p class="search__item-price"><b>' + e[i].price + "</b></p></a></li>"))
                                        : (o += '<li data-value="' + e[i].value + '"><a href="#" class="search__item search__item--text">' + e[i].label + "</a></li>"),
                                    e[i].href && (t = 1));
                            t && (o += '<li data-value="button"><a class="search__item search__item--show-all" href="' + e[0].href + '">' + e[0].show_all + "</a></li>");
                            var s = new Array();
                            for (i = 0; i < e.length; i++)
                                e[i].category && (s[e[i].category] || ((s[e[i].category] = new Array()), (s[e[i].category].name = e[i].category), (s[e[i].category].item = new Array())), s[e[i].category].item.push(e[i]));
                            for (i in s)
                                for (o += '<li class="dropdown-header">' + s[i].name + "</li>", j = 0; j < s[i].item.length; j++)
                                    o += '<li data-value="' + s[i].item[j].value + '"><a href="#">&nbsp;&nbsp;&nbsp;' + s[i].item[j].label + "</a></li>";
                            o += "</ul>";
                        }
                        a("html").addClass("is-search-keyup"), a(this).siblings("div.search__dropdown").html(o);
                    } else {
                        if (((o = ""), e.length)) {
                            for (i = 0; i < e.length; i++) this.items[e[i].value] = e[i];
                            for (i = 0; i < e.length; i++) e[i].category || (o += '<li data-value="' + e[i].value + '"><a href="#">' + e[i].label + "</a></li>");
                            s = new Array();
                            for (i = 0; i < e.length; i++)
                                e[i].category && (s[e[i].category] || ((s[e[i].category] = new Array()), (s[e[i].category].name = e[i].category), (s[e[i].category].item = new Array())), s[e[i].category].item.push(e[i]));
                            for (i in s)
                        ...
                        o ? this.show() : this.hide(), a(this).siblings("ul.dropdown-menu").html(o);
                    }
                }),
                a(this).hasClass("js-search-input")
                    ? (a(this).after('<div class="search__dropdown"></div>'), a(this).siblings("div.search__dropdown").on("click", "ul.search__list > li > a", a.proxy(this.click, this)))
        ...
        remove: function (e) {
            $.ajax({
                ...
                success: function (e) {
                    ...
                    $('#button-cart').removeClass('in_cart');
        ...
        add: function (e) {
            $.ajax({
                ...
                success: function (e) {
                    ...
                    $('.btn_wishlist_enbl').show();
                    $('.btn_wishlist_dis').hide();
        ...
        remove: function(product_id) {
            $.ajax({
                ...
                success: function(json) {
                    ...
                    $('.btn_wishlist_enbl').hide();
                    $('.btn_wishlist_dis').show();
                },
            });
        },
    },
...
window.onload = function() { 
    $('.box_home_ad').appendTo('#bf_banner');
    $('.box_home_ad_mob').appendTo('#bf_banner');
}