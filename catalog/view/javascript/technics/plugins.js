...
(function (root, factory) {
    ...
    priorityNav.doesItFit = function (_this) {
        ...
        (debounce(function () {
			...
			while (totalWidth >= (breaks[identifier][breaks[identifier].length - 1] - 1) && viewportWidth > settings.breakPoint) {
                //move item to menu
					...
					function doSelect() {
						...
						divSelect.click(function() {
							...
							if(/(iPhone|iPod|iPad)/i.test(navigator.userAgent)) { 
								if(/OS [1-8]_\d(_\d)? like Mac OS X/i.test(navigator.userAgent)) {  
									// iOS 1-8 so Do Something  
									if (iOS) return;									
								}
							}
