$(document).ready(function() {
	...
	$('[data-toggle=\'summernote\']').each(function() {
		...
		if ($(this).attr('data-lang') && $(this).attr('data-lang')!='en') {
			//$('head').append('<script type="text/javascript" src="catalog/view/javascript/summernote/lang/summernote-' + $(this).attr('data-lang') + '-' + $(this).attr('data-lang').toUpperCase() + '.min.js"></script>');
		//	$('head').append('<script type="text/javascript" src="catalog/view/javascript/summernote/lang/summernote-' + $(this).attr('data-lang') + '-' + $(this).attr('data-lang').toUpperCase() + '.min.js"></script>');
		}
