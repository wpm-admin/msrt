...
$_['column_manuf']                   = 'Производитель';

$_['text_clear_cart']                   = 'Очистить корзину';
$_['text_chec_info']                      = 'Представитель отдела продаж свяжется с вами и подтвердит дату доставки вскоре после оформления заказа, а также проинформирует вас о вариантах доставки и оплаты.';
