...
class ControllerAccountWishList extends Controller {
	...
	public function mail(){
		...
		$results = $this->model_account_wishlist->getAllWishlist();
		...
		foreach($sort_result as $customer){
			...
			$sbj = $this->language->get('sbj_wishlist_'.$customer['language_id']);
			$msg = '<div style="font-size:18px;">'.sprintf($this->language->get('mail_wishlist_'.$customer['language_id']), $customer['firstname'].' '.$customer['lastname']).'</div><br>';
